...
/* harmony import */ var _modules_modals_menu_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/menu-toggle */ "./js/modules/modals/menu-toggle.js");
/* harmony import */ var _modules_modals_about_expand__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/about-expand */ "./js/modules/modals/about-expand.js");
/* harmony import */ var _modules_modals_popup_show__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/popup-show */ "./js/modules/modals/popup-show.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_menu_toggle__WEBPACK_IMPORTED_MODULE_2__["menuToggle"])();
  Object(_modules_modals_about_expand__WEBPACK_IMPORTED_MODULE_3__["aboutExpand"])();
  ...
  window.addEventListener('load', function () {
    // initModals();
    Object(_modules_modals_popup_show__WEBPACK_IMPORTED_MODULE_4__["popupShow"])();
  });
});
...
/***/ "./js/modules/modals/about-expand.js":
/*!*******************************************!*\
  !*** ./js/modules/modals/about-expand.js ***!
  \*******************************************/
/*! exports provided: aboutExpand */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutExpand", function() { return aboutExpand; });
function aboutExpand() {
  var aboutBlock = document.querySelector('[data-about]');
  var aboutButton = aboutBlock.querySelector('[data-detailed-button]');
  var aboutDynamicParagraphs = aboutBlock.querySelectorAll('[data-paragraph]');
  aboutButton.style.display = "block";
  aboutDynamicParagraphs.forEach(function (element) {
...
/***/ "./js/modules/modals/menu-toggle.js":
/*!******************************************!*\
  !*** ./js/modules/modals/menu-toggle.js ***!
  \******************************************/
...
function menuToggle() {
  var navigationBlock = document.querySelector('[data-navigation]');
  var navigationButton = navigationBlock.querySelector('[data-expand-button]');
  var navigationList = navigationBlock.querySelector('[data-expand-list]');
  var navigationIcon = navigationButton.querySelector('[data-icon]');
  var contactsBlock = document.querySelector('[data-contacts]');
  var contactsButton = contactsBlock.querySelector('[data-expand-button]');
  var contactsList = contactsBlock.querySelector('[data-expand-list]');
  var contactsIcon = contactsButton.querySelector('[data-icon]');
...
/***/ "./js/modules/modals/popup-show.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/popup-show.js ***!
  \*****************************************/
/*! exports provided: popupShow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popupShow", function() { return popupShow; });
function popupShow() {
  var showButton = document.querySelector('[data-show-popup]');
  var popupBlock = document.querySelector('[data-popup]');
  var closeButton = popupBlock.querySelector('[data-close-popup]');
  var header = document.querySelector('[data-header]');
  var body = document.querySelector('body');
  var scrollCover = document.querySelector('[data-scroll-cover]');
